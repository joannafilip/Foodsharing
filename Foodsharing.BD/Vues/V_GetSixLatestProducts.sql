...
AS SELECT TOP (6) dbo.PropositionProduit.IdUtilisateur, dbo.PropositionProduit.IdProduit, dbo.Utilisateur.Nom, dbo.Utilisateur.Prenom, dbo.Type.Label AS Type, dbo.Produit.Nom AS NomProduit, dbo.Produit.DatePeremption, dbo.Produit.Quantite, 
